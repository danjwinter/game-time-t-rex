...
class Session {
  ...
  constructor(canvas, scoreboard, start) {
    this.initialGameObjects = new InitialGameObjects();
    this.start = start;
    ...
    this.activeBullets = [];
    this.availableBullets = this.initialGameObjects.bullets;
    ...
    this.clouds = this.initialGameObjects.clouds;
    this.cacti = this.initialGameObjects.cacti;
    this.ground = this.initialGameObjects.ground;
  ...
  get cactusVelocity() {
    return 4 + (this.score.currentScore / 30);
  }
