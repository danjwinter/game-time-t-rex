...
class Session {
  ...
  constructor(canvas, context) {
    ...
    this.availableBullets = [
      new Bullet({x: this.width - (2 * 5), y: (5 * 2), width: 5, height: 5}),
      new Bullet({x: this.width - (4 * 5), y: (5 * 2), width: 5, height: 5}),
      new Bullet({x: this.width - (6 * 5), y: (5 * 2), width: 5, height: 5})
    ]
