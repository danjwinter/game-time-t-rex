...
class Cactus extends Block {
  ...
  collidingWith(otherObject) {
    if (this.collisionPoints.topLeft.x <= otherObject.collisionPoints.bottomRight.x &&
        this.collisionPoints.topRight.x
        this.collisionPoints.topLeft.y <= otherObject.collisionPoints.bottomRight.y &&
        this.



        ||
        this.collisionPoints.bottomLeft.x <= otherObject.collisionPoints.bottomRight.x &&
        this.collisionPoints.bottomLeft.y <= otherObject.collisionPoints.bottomRight.y ||
        this.collisionPoints
     ) {
         console.log('hit that shit')
       }
    // this.collisionPoints.forEach(function(cactusPoint)) {
    //   if
      // otherObject.collisionPoints.forEach(function(otherObjectPoint) {
      //   if cactus
      // })
    // })
  }
