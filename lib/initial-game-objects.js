...
class InitialGameObjects {
  constructor() {
    this.bullets = [
      new Bullet({image: Images.bulletImage, x: canvasWidth - (2 * 15), y: (15 * 2), width: 15, height: 15}),
      new Bullet({image: Images.bulletImage, x: canvasWidth - (4 * 15), y: (15 * 2), width: 15, height: 15}),
      new Bullet({image: Images.bulletImage, x: canvasWidth - (6 * 15), y: (15 * 2), width: 15, height: 15})
    ];
    this.clouds = [
    ...
    this.ground =  [
      new Ground({image: Images.ground1, x: 0, y: 300, width: 920, height: 60, velocity: 4}),
      new Ground({image: Images.ground2, x: 920, y: 300, width: 920, height: 60, velocity: 4})
    ];
  }
}
